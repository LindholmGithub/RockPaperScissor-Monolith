...
public class Game
{
    ...
    public void Start()
    {
        ...
        MonitorService.Log.Debug("Entered method Start");
    ...
    {
        using var activity = MonitorService.ActivitySource.StartActivity();
        MonitorService.Log.Debug("Entered method DeclareWinner");
        string? winner = null;
    ...
    {
        using var activity = MonitorService.ActivitySource.StartActivity();
        MonitorService.Log.Debug("Entered method ReceivePlayerEvent");
    ...
    public GameFinishedEvent PrepareWinnerAnnouncement(GameModel game, KeyValuePair<string?, Move> p1, KeyValuePair<string?, Move> p2)
    {
        ...
        MonitorService.Log.Debug("Entered method PrepareWinnerAnnouncement");
